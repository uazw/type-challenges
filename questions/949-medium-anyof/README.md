...
```ts
type isFalse<T> = T extends  [] | false | 0 | '' ? true : keyof T extends [] ? true : false;

type Not<T extends boolean> = T extends true ? false : true;

type AnyOf<T extends readonly any[], U =  T[number]> = true extends (U extends any ? Not<isFalse<U>> : never) ? true : false;
